_base_ = [
    '../_base_/datasets/ir_detection_aihub_trainval.py',
...
albu_train_transforms = [
    ...
    dict(
        ...
        p=0.5),
    dict(
        type='GaussNoise', var_limit=(100.0, 900.0), p=0.5, per_channel=False),
    dict(
        ...
        rotate_limit=45,
        p=0.5),
    dict(type='ElasticTransform', alpha=1, sigma=50, alpha_affine=50, p=0.5),
    dict(
        type='Cutout',
        num_holes=8,
        max_h_size=32,
